 ...
 * 
 * Dependencies:
 * plugin/helpers/functions.js
 * plugin/directives/CommonDirectives.js#uiWidget
 * plugin/directives/CommonDirectives.js#ngName
 */
angular.module('ui.dados.editors.list', [])
  .directive('uiListEditor', function() {
	return {
		restrict: 'E',
		replace: true,
		require: "^list",
		...
		templateUrl: '../js/plugin/partials/ListEditor.html',
