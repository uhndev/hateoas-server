          ...
          tabview: [
            ...
            },
            {
              prompt: 'APP.HEADER.MENU.TOOLS', icon: 'fa-cog', dropdown: [
                ...
                {prompt: 'APP.HEADER.MENU.SERVICE_MAPPER', href: '/servicemapper', icon: 'fa-arrows-h'}
              ]
            }
          ],
          subview: {
            ...
            'referral': ['name', 'referraldetail', 'referral', 'altumprogramservices', 'service', 'invoice', 'invoiceservice']
          }
        }
      },
      {
