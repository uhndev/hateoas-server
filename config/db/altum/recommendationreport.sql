-- View: recommendationreport
-- returns data for recommendation report
...
SELECT client."displayName" AS "Client Name",
   ...
   FROM ((((((((((((((((altum.service
     ...
     LEFT JOIN altum.service_staff__staff_services ON ((service.id = service_staff__staff_services.id)))
